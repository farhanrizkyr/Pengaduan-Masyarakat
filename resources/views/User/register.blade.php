            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="{{route('proses-register')}}" class="row g-3" novalidate>
                         @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <label for="yourPassword" class="form-label">Password Konfimasi</label>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Allready account? <a href="/apps-user/login/">Login</a></p>
                    </div>
                  </form>
